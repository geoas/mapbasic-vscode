...
namespace BuildMapBasicProject
{
    ...
    public class IniFile
    {
        ...
        {
            _sections = new Dictionary<string, IniSection>(StringComparer.CurrentCultureIgnoreCase);
            Load(sFileName);
        }
        ...
        public System.Collections.ICollection Sections => _sections.Values;
